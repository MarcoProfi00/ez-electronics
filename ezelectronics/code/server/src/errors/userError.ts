...
const USER_IS_ADMIN_UPDATE = "Admins cannot be updated"
...
class UserIsAdminUpdateError extends Error {
    customMessage: String;
    customCode: Number;

    constructor() {
        super()         
        this.customMessage = USER_IS_ADMIN_UPDATE
        this.customCode = 401
    }
}
...
export { UserNotFoundError, UserNotManagerError, UserNotCustomerError, UserAlreadyExistsError, UserNotAdminError, UserIsAdminError, UnauthorizedUserError, UserIsAdminUpdateError }